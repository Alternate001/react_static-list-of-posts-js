 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(k,C){var z=k.length;k.push(C);e:for(;0<z;){var V=z-1>>>1,G=k[V];if(0<a(G,C))k[V]=C,k[z]=G,z=V;else break e}}function i(k){return k.length===0?null:k[0]}function n(k){if(k.length===0)return null;var C=k[0],z=k.pop();if(z!==C){k[0]=z;e:for(var V=0,G=k.length,Yi=G>>>1;V<Yi;){var vt=2*(V+1)-1,ya=k[vt],qt=vt+1,Xi=k[qt];if(0>a(ya,z))qt<G&&0>a(Xi,ya)?(k[V]=Xi,k[qt]=z,V=qt):(k[V]=ya,k[vt]=z,V=vt);else if(qt<G&&0>a(Xi,z))k[V]=Xi,k[qt]=z,V=qt;else break e}}return C}function a(k,C){var z=k.sortIndex-C.sortIndex;return z!==0?z:k.id-C.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;e.unstable_now=function(){return u.now()}}else{var o=Date,r=o.now();e.unstable_now=function(){return o.now()-r}}var s=[],m=[],v=1,f=null,p=3,h=!1,g=!1,b=!1,D=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,l=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function c(k){for(var C=i(m);C!==null;){if(C.callback===null)n(m);else if(C.startTime<=k)n(m),C.sortIndex=C.expirationTime,t(s,C);else break;C=i(m)}}function q(k){if(b=!1,c(k),!g)if(i(s)!==null)g=!0,va(I);else{var C=i(m);C!==null&&qa(q,C.startTime-k)}}function I(k,C){g=!1,b&&(b=!1,d(_),_=-1),h=!0;var z=p;try{for(c(C),f=i(s);f!==null&&(!(f.expirationTime>C)||k&&!_e());){var V=f.callback;if(typeof V=="function"){f.callback=null,p=f.priorityLevel;var G=V(f.expirationTime<=C);C=e.unstable_now(),typeof G=="function"?f.callback=G:f===i(s)&&n(s),c(C)}else n(s);f=i(s)}if(f!==null)var Yi=!0;else{var vt=i(m);vt!==null&&qa(q,vt.startTime-C),Yi=!1}return Yi}finally{f=null,p=z,h=!1}}var w=!1,S=null,_=-1,H=5,P=-1;function _e(){return!(e.unstable_now()-P<H)}function oi(){if(S!==null){var k=e.unstable_now();P=k;var C=!0;try{C=S(!0,k)}finally{C?ri():(w=!1,S=null)}}else w=!1}var ri;if(typeof l=="function")ri=function(){l(oi)};else if(typeof MessageChannel<"u"){var Po=new MessageChannel,tm=Po.port2;Po.port1.onmessage=oi,ri=function(){tm.postMessage(null)}}else ri=function(){D(oi,0)};function va(k){S=k,w||(w=!0,ri())}function qa(k,C){_=D(function(){k(e.unstable_now())},C)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(k){k.callback=null},e.unstable_continueExecution=function(){g||h||(g=!0,va(I))},e.unstable_forceFrameRate=function(k){0>k||125<k?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):H=0<k?Math.floor(1e3/k):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return i(s)},e.unstable_next=function(k){switch(p){case 1:case 2:case 3:var C=3;break;default:C=p}var z=p;p=C;try{return k()}finally{p=z}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(k,C){switch(k){case 1:case 2:case 3:case 4:case 5:break;default:k=3}var z=p;p=k;try{return C()}finally{p=z}},e.unstable_scheduleCallback=function(k,C,z){var V=e.unstable_now();switch(typeof z=="object"&&z!==null?(z=z.delay,z=typeof z=="number"&&0<z?V+z:V):z=V,k){case 1:var G=-1;break;case 2:G=250;break;case 5:G=1073741823;break;case 4:G=1e4;break;default:G=5e3}return G=z+G,k={id:v++,callback:C,priorityLevel:k,startTime:z,expirationTime:G,sortIndex:-1},z>V?(k.sortIndex=z,t(m,k),i(s)===null&&k===i(m)&&(b?(d(_),_=-1):b=!0,qa(q,z-V))):(k.sortIndex=G,t(s,k),g||h||(g=!0,va(I))),k},e.unstable_shouldYield=_e,e.unstable_wrapCallback=function(k){var C=p;return function(){var z=p;p=C;try{return k.apply(this,arguments)}finally{p=z}}}})(ts);es.exports=ts;var km=es.exports;/**
 * @license React
...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>E.jsxs("div",{className:"CommentInfo",children:[E.jsxs("div",{className:"CommentInfo__title",children:[E.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",E.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),E.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Lc=({comments:e})=>E.jsx(E.Fragment,{children:e.map(t=>E.jsx(Pc,{comment:t},t.id))}),Tc=({user:e})=>E.jsxs("p",{children:[" Posted by  ",E.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name})]}),Mc=({post:e})=>E.jsxs("div",{className:"PostInfo",children:[E.jsxs("div",{className:"PostInfo__header",children:[E.jsx("h3",{className:"PostInfo__title",children:e.title}),E.jsx(Tc,{user:e.user})]}),E.jsx("p",{className:"PostInfo__body",children:e.body}),E.jsx("hr",{}),!e.comments||e.comments.length===0?E.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}):E.jsx(Lc,{comments:e.comments})]}),jc=({posts:e})=>E.jsx(E.Fragment,{children:e.map(t=>E.jsx(Mc,{post:t},t.id))});function Rc(e){return Nc.find(t=>t.id===e)}function Dc(e){return zc.filter(t=>t.postId===e)}const Oc=Cc.map(e=>({...e,user:Rc(e.userId),comments:Dc(e.id)})),Fc=()=>E.jsxs("section",{className:"App",children:[E.jsx("h1",{className:"App__title",children:"Static list of posts"}),E.jsx(jc,{posts:Oc}),E.jsxs("div",{className:"PostList",children:[E.jsxs("div",{className:"PostInfo",children:[E.jsxs("div",{className:"PostInfo__header",children:[E.jsx("h3",{className:"PostInfo__title",children:"qui est esse"}),E.jsxs("p",{children:[" Posted by  ",E.jsx("a",{className:"UserInfo",href:"mailto:Sincere@april.biz",children:"Leanne Graham"})]})]}),E.jsx("p",{className:"PostInfo__body",children:"est rerum tempore vitae sequi sint nihil reprehenderit dolor beatae ea dolores neque fugiat blanditiis voluptate porro vel nihil molestiae ut reiciendis qui aperiam non debitis possimus qui neque nisi nulla"}),E.jsx("hr",{}),E.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]}),E.jsxs("div",{className:"PostInfo",children:[E.jsxs("div",{className:"PostInfo__header",children:[E.jsx("h3",{className:"PostInfo__title",children:"doloremque illum aliquid sunt"}),E.jsxs("p",{children:[" Posted by  ",E.jsx("a",{className:"UserInfo",href:"mailto:Julianne.OConner@kory.org",children:"Patricia Lebsack"})]})]}),E.jsx("p",{className:"PostInfo__body",children:"deserunt eos nobis asperiores et hic est debitis repellat molestiae optio nihil ratione ut eos beatae quibusdam distinctio maiores earum voluptates et aut adipisci ea maiores voluptas maxime"}),E.jsxs("div",{className:"CommentList",children:[E.jsxs("div",{className:"CommentInfo",children:[E.jsxs("div",{className:"CommentInfo__title",children:[E.jsx("strong",{className:"CommentInfo__name",children:"pariatur omnis in"})," by ",E.jsx("a",{className:"CommentInfo__email",href:"mailto:Telly_Lynch@karl.co.uk",children:"Telly_Lynch@karl.co.uk"})]}),E.jsx("div",{className:"CommentInfo__body",children:"dolorum voluptas laboriosam quisquam ab totam beatae et aut aliquid optio assumenda voluptas velit itaque quidem voluptatem tempore cupiditate in itaque sit molestiae minus dolores magni"})]}),E.jsxs("div",{className:"CommentInfo",children:[E.jsxs("div",{className:"CommentInfo__title",children:[E.jsx("strong",{className:"CommentInfo__name",children:"odio adipisci rerum aut animi"})," by ",E.jsx("a",{className:"CommentInfo__email",href:"mailto:Nikita@garfield.biz",children:"Nikita@garfield.biz"})]}),E.jsx("div",{className:"CommentInfo__body",children:"quia molestiae reprehenderit quasi aspernatur aut expedita occaecati aliquam eveniet laudantium omnis quibusdam delectus saepe quia accusamus maiores nam est cum et ducimus et vero voluptates excepturi deleniti ratione"})]})]})]})]})]});em(document.getElementById("root")).render(E.jsx(Fc,{}));
